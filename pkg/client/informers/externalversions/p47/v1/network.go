...
import (
	...
	internalinterfaces "woniuxiaoan/p47-network-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "woniuxiaoan/p47-network-controller/pkg/client/listers/p47/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.P47V1().Networks(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.P47V1().Networks(namespace).Watch(options)
			},
		},
		&p47v1.Network{},
		resyncPeriod,
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&p47v1.Network{}, f.defaultInformer)
}
